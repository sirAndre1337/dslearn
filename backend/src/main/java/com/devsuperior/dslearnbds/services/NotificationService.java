...
public class NotificationService implements DeliverRevisionObserver{
	...
	// Quando o objeto NotificationService for instanciado ele vai ser adicionado a lista como observer
	@PostConstruct
	...
	// Recebe uma Deliver corrigida e envia a notificação para o estudante;
	@Transactional
